...
adj, features0, y_train1, _, _, _, _, test_mask0 = read_data.load_data_bigdata(week=0, test_num=FLAGS.test_num, hour=0)
# Some preprocessing
        ...
        for w in range(window_slide)[:1]:
            ...
            for k in range(25):
                ...
                for epoch in range(weeks):
                    ...
                    _, features, y_train, _, _, train_mask, _, _ = read_data.load_data_bigdata(week=p,
